...
patron_small_world_negativa <- read.csv("redes_small_world_data/main-pattern-negative-fixed-small-world-table.csv", skip = 6)
...
patron_small_world_negativa <- patron_small_world_negativa %>% 
  rename(
    tick = X.step., 
...
patrones_por_configuracion <- patron_small_world_negativa %>% 
...
rmse_por_corrida <- patron_small_world_negativa %>%
  filter(tick %in% c(69, 166, 259)) %>%
...
simulation_best_config_hombres <- read.csv("redes_small_world_data/modelo_redes_preferenciales best-config-neg-hombres-small-world-table",
                                           skip= 6) 
...
simulation_best_config_hombres_plot <- ggplot(simulation_best_config_hombres_largo, aes(x = tick, group = grupo)) +
  ...
  labs(
    title = "Intención de voto bajo influencia negativa en redes de mundo pequeño,
...
ggsave("figures_small_world/neg_patron_hombres_small_world.pdf", 
       plot = simulation_best_config_hombres_plot,
       width = 16, height = 10, units = "cm")

#### Simulación de mejor configuración general ####
simulation_best_config_general <- read.csv("redes_small_world_data/modelo_redes_preferenciales best-config-neg-general-small-world-table",
                                           skip= 6) 
...
# Exportación con las medidas calculadas para los márgenes del documento
ggsave("figures_small_world/neg_patron_general_small_world.pdf", 
...
simulation_best_config_mujeres <- read.csv("redes_small_world_data/modelo_redes_preferenciales best-config-neg-mujeres-small-world-table",
                                           skip= 6) 
...
# Exportación con las medidas calculadas para los márgenes del documento
ggsave("figures_small_world/neg_patron_mujeres_small_world.pdf", 
